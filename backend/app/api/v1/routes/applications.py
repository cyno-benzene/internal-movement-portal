    ...
    return [
        ApplicationDetailResponse(
            ...
            job=JobResponse(
                ...
                short_description=getattr(app.job, 'short_description', None),
                internal_notes=getattr(app.job, 'internal_notes', None),
                ...
                visibility=getattr(app.job, 'visibility', 'invite_only'),
